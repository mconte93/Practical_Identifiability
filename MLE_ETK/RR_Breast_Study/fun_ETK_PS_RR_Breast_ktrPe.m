function [MLE] = fun_ETK_PS_RR_Breast_ktrPe(x)

l%Function to evaluate the MLE function in the optimization process with
%ktr parameter fix and persistent curve profile in the RR case
