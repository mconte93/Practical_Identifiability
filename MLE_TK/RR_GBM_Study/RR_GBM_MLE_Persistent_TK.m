...
%persistent curve in the RR-GBM case
...
load('RR_GBM_Forward_with_inverse_Persistent.mat','CA_XY_time','t_VIF')
ydata=CA_XY_time;
xdata=t_VIF;
...
%Saving options
%save('SEE_ktr_Persistent','MLE','R2','ktr_vec','MLE_opt','ktr_opt','R2_opt','xsave')
...
%Saving options
%save('SEE_ve_Persistent','MLE','R2','ve_vec','MLE_opt','ve_opt','R2_opt','xsave')
