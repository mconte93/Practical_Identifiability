...
%Saving options
%save('SEE_ktr_WashOut','MLE','R2','ktr_vec','MLE_opt','ktr_opt','R2_opt','xsave')
...
%Saving options
%save('SEE_ve_WashOut','MLE','R2','ve_vec','MLE_opt','ve_opt','R2_opt','xsave')
