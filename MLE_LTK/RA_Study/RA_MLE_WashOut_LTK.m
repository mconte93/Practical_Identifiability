...
%wash-out curve in the RA case

clear all
close all

%Load results of the inverse problem
load('RA_Inverse_Washout.mat')
ktr_opt=x(1);
ve_opt=x(2);
vp_opt=x(3);
leakage_opt=x(4); 
...
%Plot of MLE
figure(1)     
plot(ktr_vec,MLE,'k',ktr_opt,MLE_opt,'r*')
xlabel('k_{tr}')
ylabel('SSE')
title('Type II')
axis square
...
%Saving option
%save('MLE_ktr_Washout.mat','MLE','R2','ktr_vec','SSE_opt','ktr_opt','R2_opt','xsave')
