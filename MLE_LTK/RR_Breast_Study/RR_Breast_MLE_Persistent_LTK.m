...
fun=@fun_LTK_PS_RR_Breast_ktrPe;
nvar=3;
...
%Saving options
%save('MLE_vp_Persistent2.mat','MLE','R2','vp_vec','MLE_opt','vp_opt','R2_opt','xsave')
...
options=optimoptions('particleswarm','SwarmSize',200,'HybridFcn',@fmincon,'MaxIterations',500,'ObjectiveLimit',1e-16,'InitialSwarmMatrix',x0,'PlotFcn',@pswplotbestf);
fun=@fun_LTK_PS_RR_Breast_leakagePe;
nvar=3;
[x,fval,exitflag,output]  = particleswarm(fun,nvar,lb,ub,options);
...
%Saving options
%save('MLE_leakage_Persistent.mat','SSE','R2','leakage_vec','SSE_opt','leakage_opt','R2_opt','xsave')