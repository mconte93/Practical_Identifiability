%Code to run the inverse problem on the LTK model with real GBM data and
...
%Sabing option
%save('RR_GBM_Inverse_Persistent_Smooth15.mat','x')


function [MLE] = fun_RR_LTK_PS(x)
