function [MLE] = fun_LTK_PS_RR_Smooth05_ktr(x)

%Function to evaluate the MLE function in the optimization process with
%ktr parameter fix and persistent curve profile in the RR-GBM case with .05% of
%smooth in the original data

load('RR_GBM_Forward_with_inverse_Persistent_Smooth05.mat','CA_XY_time_Smo','t_VIF')
